...
def main():
    ...
    bp_fossil = pd.read_csv(os.path.join(INPUT_DIR, "shared/bp_energy.csv"), usecols=[
        "Entity",
        "Year",
        "Coal Production - EJ",
    ...
    shift_oil = pd.read_csv(os.path.join(INPUT_DIR, "fossil-fuel-production/shift_oil.csv"))
    shift_oil = pd.melt(
        shift_oil,
        id_vars=["Year"],
        var_name=["Entity"],
    ...
    shift_gas = pd.read_csv(os.path.join(INPUT_DIR, "fossil-fuel-production/shift_gas.csv"))
    shift_gas = pd.melt(
        shift_gas,
        id_vars=["Year"],
        var_name=["Entity"],
